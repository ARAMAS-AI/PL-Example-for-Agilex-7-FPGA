...
This repository contains a baseline FPGA design ("Blinky") for the Intel Agilex 7 I-Series FPGA Development Kit (`DK-DEV-AGI027RBES`).
...
* `fix_power_settings.tcl`: Script to apply Secure Device Manager (SDM) Power Management settings.
...
5. Program the board using the generated `.sof` in `output_files/` using Programmer.
